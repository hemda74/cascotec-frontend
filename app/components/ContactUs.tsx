          ...
          <div className="row">
              <div className="col-lg-6 col-md-6 p-3 " > 
                <div className={`${styles.firstIcons}`}>
                    <p className={`fs-4 mb-4 ${styles.postTitle}`} data-trans="EgyptBranch">Egypt Branch</p>
              ...
              <div className="col-lg-6 col-md-6 p-3">
                  <div className={`${styles.firstIcons}`}>
                      ...
                      <div className={``}>
                          ...
                          <p className='' data-trans="ksaAdress">KSA - Riyadh - Mosa Bin Nasser St. Borj Alnamer - office No: 506</p>
                          </div>
                      </div>   
                  </div>          
              </div>
