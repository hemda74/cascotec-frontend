     ...
     <section id="contact" className="contact">
        <div className={`text-center ${styles.titleWord}`}>
            <div className={`container mb-4`}>
                ...
                <Link href={"/contact-us"}><a className="text-white fw-semibold mb-4" data-trans="ContactUsHeadLink">{` > Contact Us`}</a></Link>
            </div>
        ...
        <div className="container col-xl-10 col-lg-12 col-md-12 mb-5">
          <div className="row">
                    ...
                    <div className={``}>
                      ...
                      <p className={`${styles.iconsColor}`}>
                        ...
                        <div className='col-sm-12'>
                            ...
                            <p className='' data-trans="egyptadress">61 Al Falki, Bab Al Louq, Abdeen, Cairo Governorate 11513, Egypt</p>
                        </div>
                    </div>   
                </div>          
              </div>
              <div className="col-lg-4 col-md-6 p-3 " > 
              <div className={`  ${styles.firstIcons}`}>
              <p className={`fs-4 mb-4 ${styles.postTitle}`}>UAE Branch</p>
                          <p className={`${styles.iconsColor}`}>
                          <BsFillTelephoneFill  size={33}/>
                          </p>
                      ...
                      <p className={`${styles.iconsColor}`}>
                          ...
                          <p className=''>Floor #14 flat #1401 Victoria Building 31 new al taawun road Sharjah - UAE. land Mark Oriana Hospital</p>
                          </div>
                      </div>   
                      </div>          
              </div>
              ...
              <p className={`fs-4 mb-4 ${styles.postTitle}`}>KSA Branch</p>
                      ...
                      <p className={`${styles.iconsColor}`}>
                          ...
                          <p className=''>KSA - Riyadh - Mosa Bin Nasser St. Borj Alnamer - office No: 506</p>
                          </div>
                      </div>   
                      </div>          
              </div>
        ...
        <div className="row gy-5 gx-lg-5">
          <div className={`col-lg-12 ${styles.contactCard}`}>
            <form action="" method="post" role="form" className={` ${styles.phpEmailForm}`}>
              ...
              <div className="text-center"><button className={`myInfo p-2 rounded fs-6 ${styles.btnClass} `} type="submit">Send Message</button></div>
            </form>
          </div>
        </div>
      </div>
