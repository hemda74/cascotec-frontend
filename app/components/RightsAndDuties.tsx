  ...
  return (
    <>
     <section className={` `}>
        ...
        <div className="container">
            <div className="row mx-0 d-flex justify-content-around align-items-center">
                <div className={`card-body col-xl-3 col-lg-3 col-md-6 col-sm-12`}>
                    <span className={`me-lg-5 ${styles.spanHead}`} data-trans="CASCOSRIGHTSANDDUTIES">{`CASCO'S RIGHTS AND DUTIES`}</span>
        ...
        <div className="container">
            <div className="row mx-0  d-flex justify-content-around align-items-center">
                <div className={`card-body col-xl-8 col-lg-8 col-md-12 col-sm-12 p-4`}>
