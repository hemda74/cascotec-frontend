...
const Ser8Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_abx7zqc', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser8Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser8Modal" aria-hidden="true">
