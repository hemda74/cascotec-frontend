...
const Ser11Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_4xh8j97', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser11Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser11Modal" aria-hidden="true">
