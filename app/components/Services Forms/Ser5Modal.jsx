...
const Ser5Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_dy0skr8', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser5Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser5Modal" aria-hidden="true">
