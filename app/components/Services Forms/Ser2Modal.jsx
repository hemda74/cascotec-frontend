...
const Ser2Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_9iua3hc', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser2Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser1Modal" aria-hidden="true">
