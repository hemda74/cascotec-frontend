...
const Ser9Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_3p1e5ft', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser9Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser9Modal" aria-hidden="true">
