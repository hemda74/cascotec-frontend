...
const Ser7Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_0hvtfhj', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser7Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser7Modal" aria-hidden="true">
