...
const Ser4Modal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_jv3whyp', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="Ser4Modal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="Ser4Modal" aria-hidden="true">
