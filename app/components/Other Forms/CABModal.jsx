...
const CABModal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_aw4j9zk', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="CABModal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="CABModal" aria-hidden="true">
            ...
            <div className="modal-content">
                ...
                <div className="modal-body p-0">
                    ...
                    <div className='text-center mb-4'>
                            <span className={` fs-5 rounded mt-0 fw-bold `} data-trans="APPLYASCAB"></span>
                        </div>
