...
const ASSESSORModal = () => {
   ...
   const sendEmail = (e) => {
     ...
     emailjs.sendForm('service_5qqa4i3', 'template_srbc9fc', form.current, 'tMN89qaA4jrvOzV4Q')
       .then((result) => {
  ...
  return (
    <div className="modal fade" id="ASSESSORModal" data-bs-keyboard="false" tabIndex={-1} aria-labelledby="ASSESSORModal" aria-hidden="true">
            ...
            <div className="modal-content">
                ...
                <div className="modal-body p-0">
                    ...
                    <div className='text-center mb-4'>
                            <span className={` fs-5 rounded mt-0 fw-bold `} data-trans="APPLYASASSESSOR"></span>
                        </div>
