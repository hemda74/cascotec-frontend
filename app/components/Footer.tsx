                    ...
                    <div className="contact">
                        <div className="">
                            ...
                            <div className={`m-auto mt-2`}>
                                <a href="https://twitter.com/AhmedHemdan72" target="_blank" rel="noopener noreferrer" className={` me-3 ms-3 ${styels.footerA}`} >< BsTwitter size={25}/></a>
                                <a href="https://www.facebook.com/profile.php?id=100009361588650" rel="noopener noreferrer" target="_blank" className={`me-3 ms-3 ${styels.footerA}`}>< BsFacebook size={25}/></a>
                                <a href={'https://www.linkedin.com/in/ahmed-hemdan-69540820'}  rel="noopener noreferrer" target="_blank" className={`me-3 ms-3  ${styels.footerA}`}> <BsLinkedin size={25}/></a>
                                <a href={'https://www.linkedin.com/in/ahmed-hemdan-69540820'} target="_blank" rel="noopener noreferrer" className={`me-3 ms-3  ${styels.footerA}`}> <BsInstagram size={25}/></a>
                                <a href="https://github.com/hemda74" target="_blank" rel="noopener noreferrer" className={`me-3 ms-3  ${styels.footerA}`}> <BsYoutube size={25}/></a>
                            </div>
                        </div>
                    </div>
                </div>
