...
import hammad from '../../../public/images/borad_of_directors/Roles/08 Dr Mai Tag/mai.jpg'
type Props = {};
    ...
    <>
      ...
      <main>
          <div className={`text-center ${styles.titleWord}`}>
            ...
            <h2 className={`text-white fw-bold mb-5`} data-trans="DrMaiTag"></h2>
          </div>
          <div className={`container row m-auto`} >
              <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-3 mb-3">
                  <Image src={hammad} className={`${styles.cardImage} rounded`} width={500} height={600} alt="mai_tag"/>
              </div>
              ...
              <span className='fs-4 fw-bold m-2 d-block' data-trans="Thedirectorgeneral1">Bio :-</span>
                <ul className='list-unstyled mt-3'>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        ...
                        <span data-trans="maitag2" className='me-4 ms-4'>{``}</span>
                    </li>	
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="maitag3" className='me-4 ms-4'>{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 mb-0 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span  data-trans="maitag4" className='ms-4 me-4'>{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="maitag5" className='me-4 ms-4'>{``}</span>
                    </li>
                </ul>
              </div>
          </div>    
