...
import hammad from '../../../public/images/borad_of_directors/Roles/12 Dr Mohamed Mossad/Mossad.jpeg'
type Props = {};
...
const ahmed_hammad:NextPageWithLayout = (props:Props) => {
  return (
    <>
      <Head>
          <title>Mohaamed Mossad | CASCO</title>
      </Head>
      <main>
          <div className={`text-center ${styles.titleWord}`}>
            ...
            <h2 className={`text-white fw-bold mb-5`} data-trans="DrMohamedMosaad"></h2>
          </div>
          <div className={`container row m-auto`} >
              <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-3 mb-3">
                  <Image src={hammad} className={`${styles.cardImage} rounded`} width={500} height={600} alt="mohamed_mossad"/>
              </div>
              ...
              <span className='fs-4 fw-bold m-2 d-block' data-trans="Thedirectorgeneral1">Bio :-</span>
                <ul className='list-unstyled mt-3'>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        ...
                        <span data-trans="mohamed_mosaad2" className='me-4 ms-4'>{``}</span>
                    </li>	
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="mohamed_mosaad3" className='me-4 ms-4'>{``}</span>
                    </li>
                </ul>
              </div>
          </div>    
