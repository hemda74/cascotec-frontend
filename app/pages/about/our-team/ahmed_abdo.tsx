...
import hammad from '../../../public/images/borad_of_directors/Roles/10 Dr Ahmed Abdo/Ahmed Abdo.jpeg'
type Props = {};
    ...
    <>
      ...
      <main>
          <div className={`text-center ${styles.titleWord}`}>
            ...
            <h2 className={`text-white fw-bold mb-5`} data-trans="DrAhmedAbdo"></h2>
          </div>
          <div className={`container row m-auto`} >
              <div className="col-lg-4 col-md-4 col-sm-12 col-xs-12 mt-3 mb-3">
                  <Image src={hammad} className={`${styles.cardImage} rounded`} width={500} height={600} alt="ahmed_abdo"/>
              </div>
              <div className={`${styles.ethicCard3} col-lg-7 col-md-8 col-sm-12 mt-5 mb-3`}>
                ...
                <ul className='list-unstyled mt-3'>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        ...
                        <span data-trans="ahmedabdo3" className='me-4 ms-4'>{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 mb-0 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span  className='ms-4 me-4' data-trans="ahmedabdo4">{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="ahmedabdo5" className='me-4 ms-4'>{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="ahmedabdo6" className='me-4 ms-4'>{``}</span>
                    </li>
                    <li className={`${styles.itemCheckTage} mt-2 d-flex`}>
                        <p><FcCheckmark size={20} className=''/></p>
                        <span data-trans="ahmedabdo7" className='me-4 ms-4'>{``}</span>
                    </li>	
                </ul>
              </div>
          </div>    
