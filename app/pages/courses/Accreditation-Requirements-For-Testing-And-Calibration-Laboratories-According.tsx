...
import courseimage from '../../public/images/courses_section/courses_images/Accreditation-Requirements-For-Testing-And-Calibration-Laboratories.png'
import ContactUs from '../../components/Courses Forms/Course10Email';
...
<>
    ...
    <div className={`text-center row ${styles.titleWord}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course10">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course10Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                        <span className='fw-bold d-block mt-3 mb-3' data-trans="Day1"></span>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline1">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline2">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline3">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline4">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline5">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline6">{``}</small>
                        <span className='fw-bold d-block mt-3 mb-3' data-trans="SecondDay"></span>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline7">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline8">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline9">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course10outline10">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course10objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course10objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course10objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course10objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course10objctive5">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course10audiance1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course10audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course10audiance3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course10audiance4">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course10audiance5">{``}</small>
                </div>
