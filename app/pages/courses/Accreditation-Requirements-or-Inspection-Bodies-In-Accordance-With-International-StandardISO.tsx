...
import courseimage from '../../public/images/courses_section/courses_images/Accreditation-Requirements-For-Inspection-Bodies-In-Accordance-With-International-StandardISO-IEC-17020-2012.png'
import ContactUs from '../../components/Courses Forms/Course7Email';
...
<>
    ...
    <div className={`text-center row ${styles.titleWord}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course7">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course7Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7outline3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7outline4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7outline5">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course7objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course7objctive5">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course7audiance1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course7audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course7audiance3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course7audiance4">{``}</small>
                </div>
