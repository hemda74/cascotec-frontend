...
<>
    ...
    <div className={`text-center row ${styles.titleWord}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course6">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course6Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline6">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6outline7">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course6objctive6">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course6audiance1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course6audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course6audiance3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course6audiance4">{``}</small>
                </div>
