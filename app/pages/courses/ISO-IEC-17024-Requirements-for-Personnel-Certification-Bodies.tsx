...
import courseimage from '../../public/images/courses_section/courses_images/ISO-IEC-17024-Requirements-for-Personnel-Certification-Bodies.png'
import ContactUs from '../../components/Courses Forms/Course12Email';
...
<>
    ...
    <div className={`text-center row ${styles.titleWord2}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course12">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course12Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline6">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline7">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline8">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline9">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline10">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12outline11">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course12objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course12objctive5">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance4">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance5">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course12audiance6">{``}</small>
                </div>
                    ...
                    <ul className="list_wideger_desc list-unstyled p-0 ">
                        ...
                        <li className={`d-flex mt-2 ${styles.liDiv}`}>
                            ...
                            <div className="row">
                                ...
                                <small className="fw-bold mt-1" data-trans="UAE"></small>
                            </div>
                        </li>					
                        <li className={`d-flex mt-2 ${styles.liDiv}`}>
                            <div className={`${styles.iconHolder}`}>
