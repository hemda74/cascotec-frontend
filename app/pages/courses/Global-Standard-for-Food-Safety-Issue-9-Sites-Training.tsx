...
import ContactUs from '../../components/Courses Forms/Course16Email';
...
<>
    ...
    <main className={`${styles.bodyContainer}`}>
        <div className={`text-center row ${styles.titleWord2}`}>
            ...
            <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course16">{``}</h3>
            <div className={''}>
                {partyTime ? 
                (
                    <>
            ...
            <div className="row pt-4">
                <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                    ...
                    <div className="description" id='description'>
                        ...
                        <small className='text-black-50 mt-2 d-inline-block' data-trans="course16Desc">{``}</small>
                    </div>
                    <div className="outline mt-4" id='outline'>
                        ...
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline4">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline5">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline6">{``}</small>
                        <span className='fw-bold d-block mt-3 mb-3' data-trans="SecondDay"></span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline7">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline8">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline9">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline10">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline11">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline12">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline13">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16outline14">{``}</small>
                    </div>
                    <div className="objective mt-4" id='objective'>
                        ...
                        <small className='text-black-50 mt-3 d-block' data-trans="course16objctive1">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16objctive2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16objctive3">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16objctive4">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course16objctive5">{``}</small>
                    </div>
                    <div className="audience mt-4" id='audience'>
                        <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                            <small className='text-black-50 mt-3 d-block' data-trans="course16audiance1">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course16audiance2">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course16audiance3">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course16audiance4">{``}</small>
                            <small className='text-black-50 mt-3 d-block' data-trans="course16audiance5">{``}</small>
                    </div>
                    <div className="estimated-time mt-4" id='estimated-time'>
                        <span className='fs-5 fw-bold d-block' data-trans="EstimatedTime">Estimated Time</span>
                            <small className="text-black-50 mt-3 d-block" data-trans="Days2Destailes"></small>
                    </div>
                </div>
