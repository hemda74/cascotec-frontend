...
import courseimage from '../../public/images/courses_section/courses_images/General-GSO-993.png'
import ContactUs from '../../components/Courses Forms/Course5Email';
...
<>
    ...
    <div className={`text-center row ${styles.titleWord}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course5">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course5Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline6">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline7">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline8">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline9">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline10">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5outline11">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course5objctive6">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course5audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course5audiance2">{``}</small>
                        <small className='text-black-50 mt-3 d-block' data-trans="course5audiance3">{``}</small>
                </div>
