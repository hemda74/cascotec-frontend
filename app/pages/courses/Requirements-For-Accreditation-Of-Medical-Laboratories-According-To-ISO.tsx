...
<>
    ...
    <div className={`text-center row ${styles.titleWord3}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course9">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course9Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9outline3">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    <span className='fs-5 fw-bold d-block' data-trans="Managementrequirements"></span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements6">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements7">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9requirements4">{``}</small>
                ...
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course9objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course9objctive5">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course9audiance1">{``}</small>
                </div>
