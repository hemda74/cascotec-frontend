...
import courseimage from '../../public/images/courses_section/courses_images/Global-Standard-for-Food-Safety-Issue--Lead-Auditor.png'
import ContactUs from '../../components/Courses Forms/Course17Email';
...
<>
    ...
    <div className={`text-center row ${styles.titleWord2}`}>
        ...
        <h3 className={`text-white col-lg-5 m-auto fw-bold mb-5`} data-trans="course17">{``}</h3>
        <div className={''}>
            {partyTime ? 
            (
                <>
        ...
        <div className="row pt-4">
            <div className={`col-lg-7 col-md-12 p-3 ${styles.courseDetailesMain}`}>
                ...
                <div className="description" id='description'>
                    ...
                    <small className='text-black-50 mt-2 d-inline-block' data-trans="course17Desc">{``}</small>
                </div>
                <div className="outline mt-4" id='outline'>
                    <span className='fs-5 fw-bold d-block' data-trans="OutLine">Course Outlines:</span>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17outline6">{``}</small>
                </div>
                <div className="objective mt-4" id='objective'>
                    ...
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive1">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive2">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive3">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive4">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive5">{``}</small>
                    <small className='text-black-50 mt-3 d-block' data-trans="course17objctive6">{``}</small>
                </div>
                <div className="audience mt-4" id='audience'>
                    <span className='fs-5 fw-bold d-block' data-trans="Audience">Audience</span>
                        <small className='text-black-50 mt-3 d-block' data-trans="course17audiance1">{``}</small>
                </div>
                <div className="estimated-time mt-4" id='estimated-time'>
                        <span className='fs-5 fw-bold d-block' data-trans="EstimatedTime">Estimated Time</span>
                            <small className="text-black-50 mt-3 d-block" data-trans="Days5Destailes"></small>
                    </div>
            </div>
