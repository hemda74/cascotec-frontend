...
import EditSiteInfoComp from '../../../../../components/EditSiteInfoComp'
type Props = {};
const dummyData={
...
export const edit_site_info:NextPageWithLayout = (props:Props) => {
  return (
    <>
    <EditSiteInfoComp  timezones={dummyData.timezones} />
    </>
  )
}
// tenant admin orgnaizations details pages shares an OrgDetails layout which includes navbar and site nav.
edit_site_info.getLayout = function getLayout(index: ReactElement) {
    return <OrgDetailsLayout childern={index}></OrgDetailsLayout>;
  };
  
  export default edit_site_info;
